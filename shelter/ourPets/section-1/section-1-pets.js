...
let rigthBtnN = document.querySelector('.our-friends__normal-R');
let rigthForce = document.querySelector('.our-friends__force-R');
...
rigthBtnN.onclick = function(){
  righting();
  console.log('rigthBtnN');
}
rigthForce.onclick = function(){
